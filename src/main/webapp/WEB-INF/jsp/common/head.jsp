...
<!--时间-->
 ...
 <section class="publicMian ">
     <div class="left">
         ...
         <nav>
             <ul class="list">
                 <li ><a href="${pageContext.request.contextPath }/sys/sp/splist.do">商品管理</a></li>
              <li ><a href="${pageContext.request.contextPath }/sys/bill/list.do">订单管理</a></li>
              <li><a href="${pageContext.request.contextPath }/sys/provider/list.do">供应商管理</a></li>
